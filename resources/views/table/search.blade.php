                ...
                <form action="{{ url('/search') }}" type="get">
                    <div class="form-row m-5">
                        ...
                        <div class="form-group col-md-4">
                            <label>Od</label>
                            <input type="date" class="form-control" name="Od_date" value="{{ $Od_date}}">
                        </div>
                        <div class="form-group col-md-4">
                            <label>Do</label>
                            <input type="date" class="form-control" name="Do_date" value="{{ $Do_date}}">
                        </div>
                        <button class="btn btn-outline-dark my-2 m-3">search</button>
                    </div>
                </form>
                <form action="{{ url('/export') }}" type="get">
                    <div class="form-row m-5">
                        <div class="form-group col-md-4">
                            <input type="hidden" class="form-control" name="Od_date" value="{{ $Od_date}}">
                        </div>
                        <div class="form-group col-md-4">
                            <input type="hidden" class="form-control" name="Do_date" value="{{ $Do_date}}">
                        </div>
                        <button class="btn btn-outline-dark my-2 m-3">export to excel</button>
                    </div>
                </form>
